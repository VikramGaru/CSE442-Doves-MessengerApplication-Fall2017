...
//Written by Qinxin Tian, check if there is an account for the user.
app.post('/deluser', function(req,res) {
  console.log('Email:' + req.body.email);
  console.log('password:' + req.body.password);
  //Check it is the owner of the account.
  var y1=login(req.body.email,req.body.password);
  y1.then(function(a){
    if(!a){
      res.write('0');
      ...
      var y2 = deleteUser(req.body.email);
      y2.then(function(a){
		  if(!a){
		    res.write('0');
		  }
...
/* Below is the code for the WebSocket server edited by Qinxin Tian and Jeiwei Shen*/
